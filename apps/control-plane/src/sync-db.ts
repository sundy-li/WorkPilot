...
import { syncPostgresDatabase } from "./storage/sync";
...
if (!databaseUrl) {
  throw new Error("DATABASE_URL is required to sync the database.");
}
...
console.log(`Database schema "${schema}" has been synced.`);
